...
namespace kstelakis.MarkdownForTMP
{
    public class EmpasisTests
    {
        ...
        private static string HighlightedTextBackgroundColorHex => go.GetComponent<MarkdownFormatter>().HighlightedTextBackgroundColorHex;
        ...
        public IEnumerator TestBoldAndItalics()
        {
            ...
            tmp.text = "___Bold and Italic Text___";
            yield return null;
            Assert.AreEqual("<i><b>Bold and Italic Text</b></i>", tmp.text, "Bold and italic text should be converted to &lt;b&gt; and &lt;i&gt; tags");
        }
