...
namespace kstelakis.MarkdownForTMP
{
    ...
    public class ImagesAndLinksTests
    {
        ...
        private static string CodeBlockFontName => go.GetComponent<MarkdownFormatter>().CodeFontName;
        private static string CodeBlockColorHex => go.GetComponent<MarkdownFormatter>().CodeFontColorHex;
