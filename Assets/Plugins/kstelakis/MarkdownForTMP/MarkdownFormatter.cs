...
namespace kstelakis.MarkdownForTMP
{
    ...
    public class MarkdownFormatter : MonoBehaviour, IPointerClickHandler
    {
        ...
        [SerializeField] private Color codeBackgroundColor = ColorUtility.TryParseHtmlString("#39312C", out Color color) ? color : Color.gray;
        [SerializeField] private Color highlightedTextBackgroundColor = ColorUtility.TryParseHtmlString("#FFFF00AA", out Color color) ? color : Color.yellow;
